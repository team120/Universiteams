...
echo EMAIL_USER="info@universiteams.com" >> $ENV_FILE
...
echo SUPER_ADMIN_EMAIL="$SUPER_ADMIN_EMAIL" >> $ENV_FILE
echo SUPER_ADMIN_PASSWORD="$SUPER_ADMIN_PASSWORD" >> $ENV_FILE
